package dev.flida.flida_auth_sdk_android
...
import dev.flida.sdk.models.FlidaUser // Check if this exists, actually it is UserInfoResponse in model
    ...
    when (this) {
        ...
        is FlidaEvent.LoggedOut -> {
            ...
            map["logoutReason"] = reason.name.lowercase().let { 
                // Map to flutter enum string values: userInitiated, sessionExpired, unauthorized
                // Android enum: USER_INITIATED, SESSION_EXPIRED, UNAUTHORIZED
                when(reason) {
